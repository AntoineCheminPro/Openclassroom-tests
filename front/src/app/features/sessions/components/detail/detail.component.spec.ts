...
describe('DetailComponent', () => {
  ...
  it('should fetch a session on initialization', () => {
    expect(mockSessionApiService.detail).toHaveBeenCalledWith('1');
  });

  it('should delete the session and navigate on delete', () => {
  ...
  it('should fetch and assign teacher on initialization', async () => {
    fixture.detectChanges(); // Force component to update
    ...
    expect(component.teacher!.lastName).toBe('Doe');
  });
});
