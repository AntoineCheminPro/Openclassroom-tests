...
@Tag("api/teacher")
public class TeacherControllerIT extends AbstractAuthenticatedControllerIT {
    ...
    public void UserController_FindById_ShouldReturnOkResponse() throws Exception {
        ...
        mockMvc.perform(get("/api/teacher/{id}", teacherId)
                ...
                .andExpect(jsonPath("$.firstName").value("teacher_firstname1"))
                .andExpect(jsonPath("$.lastName").value("teacher_lastname1"));
    }
