...
@Tag("api/session")
public class SessionControllerIT extends AbstractAuthenticatedControllerIT {
    ...
    public void setup() {
        ...
        var secondTestUser = User.builder()
                .admin(true)
                .firstName("Test")
                .lastName("User")
                ...
                .build();
        anotherUser = userRepository.save(secondTestUser);
    }
    ...
    public void UserController_Create_ShouldReturnUnauthorizedResponse() throws Exception {
        ...
        mockMvc.perform(post("/api/session", authenticatedUser.getId())
    ...
    public void SessionController_Participate_ShouldReturnUnAuthorizedResponse() throws Exception {
        mockMvc.perform(post("/api/session/{id}/participate/{userId}", sessionId, authenticatedUser.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isUnauthorized());
    }
    ...
    public void SessionController_NoLongerParticipate_ShouldReturnUnAuthorizedResponse() throws Exception {
        mockMvc.perform(delete("/api/session/{id}/participate/{userId}", sessionId, authenticatedUser.getId())
                        .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isUnauthorized());
    }
    ...
    public void SessionController_Update_ShouldReturnOkResponse() throws Exception {
        ...
        var lstUsers = Arrays.asList(authenticatedUser.getId());
        var sessionDto = SessionDto.builder()
                .id(sessionId)
